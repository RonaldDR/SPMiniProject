...
public class HorizontalChart extends JFrame {

  public HorizontalChart(String applicationTitle, String chartTitle, String[] horiz, int[] vert, int c) {
  ...
  public static void generateChart(String[] horiz, int[] vert, String desc, int c) {
    HorizontalChart chart = new HorizontalChart(desc, desc, horiz, vert, c);
    chart.pack();
